...
<body>
	<div class="container" style="width: 400px; margin-top: 50px;">
		<h3 class="text-center mb-4">
			<b>Iniciar Sesión Club</b>
		</h3>

		<!-- Formulario de inicio de sesiÃ³n -->
		<form id="loginClubForm" action="loginClub" method="POST">
			<!-- Correo -->
			<div class="mb-3">
				<input type="text" id="emailClub" name="emailClub" class="form-control"
		...
		<div class="text-center mt-3">
			<p>
				¿Tienes un club no registrado? <a href="registrarseClub.jsp">Registrarse</a>
			</p>
			<p>
